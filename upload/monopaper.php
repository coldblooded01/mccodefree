...
$content = mysqli_fetch_assoc($q);
mysqli_free_result($q);
print
        "<table width=75% border=1><tr><td>&nbsp;</td> <td><a href='gym.php'>LOCAL GYM</a></td> <td><a href='halloffame.php'>HALL OF FAME</a></td></tr><tr><td><img src='http://img190.imageshack.us/img190/6798/ad1za.png' alt='Ad' /></td><td colspan=2>".nl2br($content['content'])."</td></tr>
</table>";
$h->endpage();
